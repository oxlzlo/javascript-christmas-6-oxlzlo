...
## 🔍 기능 구현 목록
  ...
  ### 단위 테스트 구현
    ...
    - [x] 방문 날짜에 숫자가 아닌 문자 입력시 에러 발생 테스트
    - [x] 방문 날짜가 1 이상 31 이하의 숫자가 아닌 경우 에러 발생 테스트
    - [x] 메뉴판에 없는 메뉴일 경우 에러 발생 테스트
    - [x] 메뉴의 개수가 1 이상의 숫자가 아닐 경우 에러 발생 테스트
    - [x] 주문 메뉴 형식이 예시와 다를 경우 에러 발생 테스트
    - [x] 중복 메뉴를 입력한 경우 에러 발생 테스트
    - [x] 주문 메뉴의 수량을 입력하지 않은 경우 에러 발생 테스트